...
class _ScanPageWidgetState extends State<ScanPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ScanPage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SCAN_PAGE_PAGE_ScanPage_ON_INIT_STATE');
      logFirebaseEvent('ScanPage_custom_action');
      await actions.lockOrientation();
      logFirebaseEvent('ScanPage_update_app_state');
      setState(() {
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'kwo0zai4' /* Add a EU COVID Pass to sleeq */,
                                          ),
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'SCAN_SCAN_MY_C_O_V_I_D_PASS_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_launch_u_r_l');
                                            await launchURL(
                                                'https://app.getcovidpass.eu/');
                                          },
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            '9er9doon' /* Scan my COVID Pass */,
                                          ),
                                          icon: Icon(
