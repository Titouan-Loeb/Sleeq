    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'phone_number':
          ...
          break;
        case 'occupied_size':
          result.occupiedSize = serializers.deserialize(value,
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  double? get occupiedSize => _$this._occupiedSize;
  set occupiedSize(double? occupiedSize) => _$this._occupiedSize = occupiedSize;
